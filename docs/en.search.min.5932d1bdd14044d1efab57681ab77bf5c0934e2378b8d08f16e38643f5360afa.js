...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/aboutme/flexsearch.min.js');loadScript('/aboutme/en.search-data.min.f0284fc14305ebdc12afb43a916f95f34dc33707654f14b46979a066f215af8d.js',function(){input.required=false;search();});}
