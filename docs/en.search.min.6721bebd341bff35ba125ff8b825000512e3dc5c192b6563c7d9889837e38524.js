...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/aboutme/flexsearch.min.js');loadScript('/aboutme/en.search-data.min.65d5a7821c3030713b88f2d4a7607b8de4a11574b576cc33559a5ba35bae7e94.js',function(){input.required=false;search();});}
