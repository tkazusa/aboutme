...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/aboutme/flexsearch.min.js');loadScript('/aboutme/en.search-data.min.cdd3ffd46dcf5b63daaf25ebb1a3083943b7e382da23a9a45343bc22f2be29cd.js',function(){input.required=false;search();});}
